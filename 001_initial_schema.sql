...
CREATE TABLE public.trusts (
    ...
    -- Trust details
    name TEXT NOT NULL,                          -- "Smith Family Irrevocable Trust"
    trust_date DATE NOT NULL,                    -- Date trust was established
    trust_type TEXT DEFAULT 'ILIT',              -- ILIT, Gift Trust, etc.
    ...
    -- Crummey settings
    withdrawal_period_days INTEGER DEFAULT 30,   -- 30 or 60 typically
...
CREATE TABLE public.beneficiaries (
    ...
    guardian_email TEXT,                         -- Notices go here if minor
    
    -- Withdrawal share (for pro-rata calculations)
    share_percentage DECIMAL(5,2) DEFAULT 100.00, -- % of each gift they can withdraw
...
CREATE TABLE public.contributions (
    ...
    description TEXT,                            -- "Annual premium payment", etc.
...
CREATE TABLE public.notices (
    ...
    withdrawal_amount DECIMAL(12,2) NOT NULL,    -- Their pro-rata share
    withdrawal_deadline DATE NOT NULL,
    
    -- Delivery tracking
    recipient_email TEXT NOT NULL,               -- Could be guardian email if minor
    ...
    -- Acknowledgment
    acknowledgment_token UUID DEFAULT uuid_generate_v4(), -- Unique token for ack link
    acknowledged_at TIMESTAMPTZ,
    acknowledged_by_name TEXT,                   -- Signature/name entered
...
CREATE TABLE public.audit_log (
    ...
    -- What happened
    action TEXT NOT NULL,                        -- 'notice_sent', 'notice_acknowledged', etc.
    entity_type TEXT NOT NULL,                   -- 'trust', 'beneficiary', 'contribution', 'notice'
...
-- Notices: users can view notices for their trusts
...
-- Public policy for acknowledgment (anyone with token can acknowledge)
CREATE POLICY "Anyone can acknowledge with valid token" ON public.notices
...
BEGIN
    ...
    LOOP
        ...
        withdrawal_amt := LEAST(
            ...
            18000.00  -- 2024 annual exclusion amount (update as needed)
        );
